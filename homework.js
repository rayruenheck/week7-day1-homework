...
// //Expect['Fido','Gizmo']
var dogNames = ['Max','Fido','Gizmo', 'Nala']
function dogNamesCount (str) {
    return dogNames.filter(x => str.includes(x))
}
    

console.log(dogNamesCount("Hello, my dog is Max, and they have purple eyes!"))
...
function inchesToFeet(heightsInInches){
    return heightsInInches.map(x => x/12)
}
...
// // 234125
let findAMax=[123,5436,45784,1234,34,65,234125,645,3452,13216,49]
console.log(findAMax.sort((a,b) => {return b-a;})[0])
// Question #5
